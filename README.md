<div align="center">
  <img height="150" src="https://res.cloudinary.com/lrmn/image/upload/v1685720449/lucycircle_d0shk6.png"/>
</div>
...
```bash
git clone <https://github.com/madebytragic/lucybot-app.git>
```

###
This is a free (and easy to use) alternative to dashboard website discord bot

###
<h1 style="text-align: center;"><a href="https://lrmn.is-a.dev/">#LUCY</a></h1>

<div align="center">
  <img width="80%" src="https://res.cloudinary.com/lrmn/image/upload/v1685861785/lrmn.dev/ogelucy_oow3ip.png">
</div> 
